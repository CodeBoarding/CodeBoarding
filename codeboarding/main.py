...
def main():
    """Main entry point for the codeboarding CLI."""
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  codeboarding https://github.com/user/repo1
  codeboarding https://github.com/user/repo1 --output-dir ./docs
  codeboarding https://github.com/user/repo1 https://github.com/user/repo2 --output-dir ./output
  codeboarding --help
        """
    )
    parser.add_argument(
