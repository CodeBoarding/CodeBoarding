...
from typing import get_origin, Protocol

from pydantic import BaseModel, Field
from pydantic.fields import FieldInfo

from agents.cluster_ids import CodeBoardingClusterId
...
class Relation(LLMBaseModel):
    ...
    evidence_references: list[SourceCodeReference] = Field(
        default_factory=list,
        description="Verified source symbols supporting a non-static component interaction.",
    )
    ...
    def merge_edges_from(self, relation: Relation) -> None:
        ...
        if not self.evidence_references:
            self.evidence_references = relation.evidence_references
