"""Local incremental analysis command."""
...
from utils import ANALYSIS_FILENAME, monitoring_enabled
...
def add_arguments(subparsers: argparse._SubParsersAction, parents: list[argparse.ArgumentParser]) -> None:
    subparsers.add_parser(
        "incremental",
        parents=parents,
        help="Update method-affected scopes in an existing local analysis.",
    )
