```mermaid
graph LR
    Discovery_Orchestrator_Language_Registry["Discovery Orchestrator & Language Registry"]
    Multi_Language_Project_Scanners["Multi-Language Project Scanners"]
    Filesystem_Intelligence_Filtering["Filesystem Intelligence & Filtering"]
    Discovery_Orchestrator_Language_Registry -- "validates repository state for analysis consistency" --> Filesystem_Intelligence_Filtering
    Discovery_Orchestrator_Language_Registry -- "orchestrates project boundary discovery via strategy pattern" --> Multi_Language_Project_Scanners
    Multi_Language_Project_Scanners -- "filters project candidates against ignore patterns" --> Filesystem_Intelligence_Filtering
    click Discovery_Orchestrator_Language_Registry href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Discovery_Orchestrator_Language_Registry.md" "Details"
    click Multi_Language_Project_Scanners href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Multi_Language_Project_Scanners.md" "Details"
    click Filesystem_Intelligence_Filtering href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Filesystem_Intelligence_Filtering.md" "Details"
```
...
- [`repo_utils/ignore.py`](https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboardingrepo_utils/ignore.py)
  - `repo_utils.ignore.RepoIgnoreManager.should_ignore` ([L230-L258](https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboardingrepo_utils/ignore.py#L230-L258)) - Method
  - `repo_utils.ignore.RepoIgnoreManager.filter_paths` ([L260-L262](https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboardingrepo_utils/ignore.py#L260-L262)) - Method
