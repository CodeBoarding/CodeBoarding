...
graph LR
    ...
    Statistical_State_Engine["Statistical State Engine"]
    Monitoring_Integration_Bridge["Monitoring Integration Bridge"]
    State_Serialization_Provider["State Serialization Provider"]
    Execution_Lifecycle_Controller -- "pushes lifecycle events and raw timing data to" --> Statistical_State_Engine
    Monitoring_Integration_Bridge -- "invokes context managers from" --> Execution_Lifecycle_Controller
    Statistical_State_Engine -- "provides data structures to" --> State_Serialization_Provider
    Monitoring_Integration_Bridge -- "queries or injects metrics into" --> Statistical_State_Engine
    Execution_Lifecycle_Controller -- "calls" --> State_Serialization_Provider
    Statistical_State_Engine -- "calls" --> Monitoring_Integration_Bridge
```
