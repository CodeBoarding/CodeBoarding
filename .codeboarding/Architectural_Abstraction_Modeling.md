...
graph LR
    ...
    Component_Modeling_API_Definition -- "Provides structured analysis insights and relationship projections" --> Architectural_Synthesis_Cluster_Orchestrator
...
- `agents.agent_responses.ComponentRelations`:588-596
