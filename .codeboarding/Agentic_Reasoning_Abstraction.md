```mermaid
graph LR
    Agent_Orchestration_Execution_Core["Agent Orchestration & Execution Core"]
    Architectural_Reasoning_Strategy["Architectural Reasoning Strategy"]
    Context_Model_Management["Context & Model Management"]
    Prompt_Engineering_Factory["Prompt Engineering Factory"]
    Static_Analysis_Data_Provider["Static Analysis Data Provider"]
    Architectural_Reasoning_Strategy -- "uses" --> Agent_Orchestration_Execution_Core
    Architectural_Reasoning_Strategy -- "queries" --> Context_Model_Management
    Agent_Orchestration_Execution_Core -- "requests instructions from" --> Prompt_Engineering_Factory
    Agent_Orchestration_Execution_Core -- "utilizes" --> Static_Analysis_Data_Provider
    Context_Model_Management -- "analyzes data within" --> Static_Analysis_Data_Provider
    Agent_Orchestration_Execution_Core -- "calls" --> Architectural_Reasoning_Strategy
    Architectural_Reasoning_Strategy -- "calls" --> Prompt_Engineering_Factory
    Architectural_Reasoning_Strategy -- "calls" --> Static_Analysis_Data_Provider
    Context_Model_Management -- "calls" --> Prompt_Engineering_Factory
    click Agent_Orchestration_Execution_Core href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Agent_Orchestration_Execution_Core.md" "Details"
    click Architectural_Reasoning_Strategy href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Architectural_Reasoning_Strategy.md" "Details"
    click Context_Model_Management href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Context_Model_Management.md" "Details"
    click Prompt_Engineering_Factory href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Prompt_Engineering_Factory.md" "Details"
    click Static_Analysis_Data_Provider href "https://github.com/CodeBoarding/CodeBoarding/blob/main/.codeboarding/Static_Analysis_Data_Provider.md" "Details"
```
...
### Agent Orchestration & Execution Core [[Expand]](./Agent_Orchestration_Execution_Core.md)
...
### Architectural Reasoning Strategy [[Expand]](./Architectural_Reasoning_Strategy.md)
...
### Context & Model Management [[Expand]](./Context_Model_Management.md)
...
### Prompt Engineering Factory [[Expand]](./Prompt_Engineering_Factory.md)
...
### Static Analysis Data Provider [[Expand]](./Static_Analysis_Data_Provider.md)
