...
class DiagramGenerator:
    ...
    def _build_incremental_clustering_hierarchy(
        ...
        root_analysis: AnalysisInsights,
        sub_analyses: dict[str, AnalysisInsights],
        root_partitions: dict[str, ClusterResult],
    ) -> ClusterScopeResult:
        ...
        def scope_input(scope_id: str, graphs: Mapping[str, CallGraph]) -> ClusterScopeInput:
            ...
            if persisted is None:
                return ClusterScopeInput(partitions=partitions)
            return ClusterScopeInput(
                partitions=partitions,
                previous_owner=previous_ownership(persisted, partitions, scope_id, self.repo_location),
            ...
            def precomputed_ids(scope: AnalysisInsights) -> list[str]:
                return [
                    ...
                    and (
                        ...
                        or (
                            (group := self._clustering_groups.get(component.component_id)) is not None
