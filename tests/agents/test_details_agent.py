...
class TestDetailsAgent(unittest.TestCase):
    ...
    def test_run_scope_skips_local_reclustering(self):
        ...
        expected = (AnalysisInsights(description="done", components=[], components_relations=[]), scope.partitions)
        ...
        self.assertIs(run_clustered.call_args.args[2], scope.partitions)
