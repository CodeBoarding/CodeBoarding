...
def generate_frontmatter(file_name: str, component_name: Optional[str] = None) -> str:
        ...
        if comp.referenced_source_code:
            ...
            for reference in comp.referenced_source_code:
                ...
                if not reference.reference_file:
                    continue
                if not reference.reference_file.startswith(root_dir) and Path(reference.reference_file).is_absolute():
                    qn_list.append(f"{reference.llm_str()}")
                    continue
