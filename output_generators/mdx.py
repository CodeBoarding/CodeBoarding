...
This documentation was generated by [CodeBoarding](https://github.com/CodeBoarding/GeneratedOnBoardings) to provide comprehensive architectural insights into the mcp-agent framework.
    ...
    for comp in insights.components:
        detail_lines.append(component_header(comp.name, expanded_components, demo))
...
def component_header(component_name: str, expanded_components: set[str], demo: bool = False) -> str:
    """
    Generate a header for a component with its name and a link to its details.
    """
    sanitized_name = sanitize(component_name)
    if component_name in expanded_components and demo:
