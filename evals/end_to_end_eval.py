...
def run_pipeline_for_project(project_info: Dict[str, str], output_base_dir: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        cmd = [sys.executable, "demo.py", repo_url, "--output-dir", str(output_dir)]  # Use the same Python interpreter
        ...
        if result.returncode == 0:
            ...
            return {
                ...
                "files_generated": {"json": len(json_files), "markdown": len(md_files)},
