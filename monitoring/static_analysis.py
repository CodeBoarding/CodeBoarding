...
class StaticAnalysisMetrics:
    ...
    def add_file_metrics(self, language: str, total_files: int, error_count: int) -> None:
        metrics = {"total_files": total_files, "errors": error_count}
    ...
    def add_language_error(self, language: str, error_message: str) -> None:
        self.errors[language] = {"total_files": 0, "errors": 1, "error_message": error_message}
        self.file_counts[language] = {"total_files": 0, "errors": 1}

    def to_dict(self) -> dict:
        return {"timing": self.timing, "file_counts": self.file_counts, "errors": self.errors}
